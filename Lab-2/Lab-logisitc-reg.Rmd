...
pacman::p_load(tidyverse, DT, lmerTest, lme4, reactable,
               broom.mixed, knitr, kableExtra, ggrepel, mgcv, visreg,
               dplyr, ggplot2, readr, modelsummary, tidyr, 
               easystats, broom, emmeans, marginaleffects, performance, arm,
               install = TRUE)
...
The reported odds ratios in the original output describe how much **less likely** a group is to support spending compared to another group. To express how much **more likely** one group is compared to another, we compute the **inverse** of the odds ratio:
...
Political views have the strongest effect on the dependent variable, given the largest deviance reduction. 
Age and sex also have a significant impact, with similar deviance reductions. Socioeconomic status (sei10) matters but has a smaller effect compared to other predictors.
